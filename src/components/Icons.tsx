...
export function MaleIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M12 2C10.3 2 9 3.3 9 5s1.3 3 3 3 3-1.3 3-3-1.3-3-3-3zm-2 8c-1.7 0-3 .7-3 2v6h2v6h6v-6h2v-6c0-1.3-1.3-2-3-2h-4z"/>
    </svg>
  );
}

export function FemaleIcon({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M12 2C10.3 2 9 3.3 9 5s1.3 3 3 3 3-1.3 3-3-1.3-3-3-3zm-3 8c-1.1 0-2 .5-2 1.5l2 8.5h2v4h2v-4h2l2-8.5c0-1-.9-1.5-2-1.5H9z"/>
    </svg>
  );
}
